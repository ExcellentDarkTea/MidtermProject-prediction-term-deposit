...
def preprocess_data(df: pd.DataFrame, target: str, scaler_numeric: bool = True, scaler_type: str = 'standard') -> Tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series, object, OneHotEncoder]:
    """
    ...
    print(train_set.columns, val_set.columns)
